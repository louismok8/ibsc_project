...
class Dataset:
    ...
    def compute_all_lesion_volumes(self):
        """
        Compute lesion volumes for all patients.
        """
        for patient in self.patients:
            patient.compute_lesion_volumes()


    def compute_all_lesion_centroids(self):
        """
        Compute centroids for all lesions in the dataset.
        """
        for patient in self.patients:
